...
/*this function takes in a line of data and parses it
 inputs: line: a line in the input file
 stats: an array of stats from the input line
...
/*this function takes in the stats (populated in pre_proc())  and determines which players fall
into top categories*/
...
//S,R,A stand for scorrer, rebounder, assister.
    ...
    for (int i = 1; i < 7; i++){
        ...
        switch(i){
            case 1:
                CS_min = names[min_idx];
                CS_max = names[max_idx];
            break;
            case 2:
                CR_min = names[min_idx];
                CR_max = names[max_idx];
            break;
            case 3:
                CA_min = names[min_idx];
                CA_max = names[max_idx];
            break;
            case 4:
                MS_min = names[min_idx];
                MS_max = names[max_idx];
            break;
            case 5:
